...
export const SERVICES: ServiceItem[] = [
  {
    id: 'flex',
    title: 'Flex Banners',
    description: 'Large-format flex banner systems for campaigns, events, and outdoor brand visibility. Roll-ups, X-banners, snapper frames, teardrop flags, and backdrop banners.',
  ...
  },
  {
    ...
    description: 'Professional-grade self-adhesive vinyl for interior, exterior, and campaign branding. Wall graphics, window vinyl, vehicle branding for campaigns, and surface wraps.',
  ...
  },
  {
    ...
    description: 'Precision-printed clear vinyl for storefronts, offices, and premium glass branding. Logo decals, window graphics, frosted effects, and visibility control.',
