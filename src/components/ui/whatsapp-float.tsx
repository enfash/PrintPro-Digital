...
const WhatsAppIcon = () => (
  ...
  >
    ...
    <path d="M16.5 12a4.5 4.5 0 0 0-4.5-4.5m0 0a4.5 4.5 0 0 0-4.5 4.5m4.5-4.5V3M3 3l18 18"></path>
  </svg>
);


const WHATSAPP_NUMBER = "2348012345678"; // Replace with BOMedia's number
...
export default function WhatsAppFloat() {
  ...
  return (
    <Button asChild size="icon" className="fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-xl bg-green-500 hover:bg-green-600 text-white z-50 animate-bounce-in">
