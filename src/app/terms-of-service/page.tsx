                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-12">
                        ...
                        <div className="prose prose-slate max-w-none">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Our Services</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Artwork & Design Responsibility</h2>
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Colour Variation Disclaimer</h2>
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Turnaround Time</h2>
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Payment Terms</h2>
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Refunds & Reprints</h2>
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Delivery & Installation</h2>
                            <ul className="list-disc pl-6 space-y-2 text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Limitation of Liability</h2>
                            <p className="text-slate-600 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-2">Changes to These Terms</h2>
                            <p className="text-slate-600 mb-6">
